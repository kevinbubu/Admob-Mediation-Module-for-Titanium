...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','chocolabs.admobmediation.js')
	...
	f = os.path.join(cwd,'Classes','ChocolabsAdmobmediationModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','chocolabs.admobmediation.js']
